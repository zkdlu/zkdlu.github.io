...
기본생성자가 없는 경우 아래의 예외가 발생한다.

```bash
org.hibernate.InstantiationException: No default constructor for entity:  : com.zkdlu.communicate.DemoEntity
```

JPA 표준에 엔티티는 파라미터가 없는 생성자가 있어야 한다.
